...
//        filePath = dest.getAbsolutePath();
       ...
       String demoVideoFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Megaplay/";
       String demoVideoPath = demoVideoFolder + "music.mp3";
       String demoimagePath = demoVideoFolder + "voice.mp3";
       String demoVideoPathoutput = demoVideoFolder + "outputsunny.mp3";

       //------------------------------------------------------------ Working
        String s="-i "+demoimagePath+" -i "+demoVideoPath+" -filter_complex amix=inputs=2:duration=longest "+demoVideoPathoutput;

        String[] complexCommand= s.split(" ");
        ...
        //       String demoVideoFolder = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Megaplay/";
//       String demoVideoPath = demoVideoFolder + "13127.mp4";
//       String demoimagePath = demoVideoFolder + "megaplay.png";
//       String demoVideoPathoutput = demoVideoFolder + "output.mp4";

      //  String[] complexCommand = {"-y", "-i", yourRealPath, "-s", "160x120", "-r", "25", "-vcodec", "mpeg4", "-b:v", "150k", "-b:a", "48000", "-ac", "2", "-ar", "22050", filePath};


      //  String[] complexCommand = {"ffmpeg", " -i" , demoVideoPath, " -i" ,demoimagePath, " -filter_complex amix=inputs=2:duration=longest ", demoVideoPathoutput};

      //working//  String s="-i "+demoVideoPath+" -i "+demoimagePath+" -i "+demoimagePath+" -filter_complex [0:0][1:0][2:0]concat=n=3:v=0:a=1[out] -map [out] "+demoVideoPathoutput;



//working
//        String[]   complexCommand = new String[]{"-y", "-i", demoVideoPath, "-i", demoimagePath, "-filter_complex",
//                "[0:v][1:v]overlay=" + 10 + ":" + 1 + 2 +
//                        ":enable='between" + "(t," + 0 + "," + 18 + ")"
//                        + "'[out]", "-map", "[out]", demoVideoPathoutput};
...
//        String[]   complexCommand = new String[]{"ffmpeg -i",demoVideoPath, "-i", demoimagePath, "-filter_complex",
//                "[1][0]scale2ref=w='iw*5/100':h='ow/mdar'[wm][vid];[vid][wm]overlay=10:10" , demoVideoPathoutput};
